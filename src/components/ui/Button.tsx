...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: 'border border-border-inner bg-surface hover:bg-surface-hover text-on-background',
      ghost: 'hover:bg-surface-hover text-secondary-text hover:text-on-background',
